...
//    public void navigateToDrive() { //to create a method for a Drive button
//
//        WebElement driveElement = Driver.get().findElement(By.cssSelector("[title='Drive']")); // locator for a Drive button
//        BrowserUtils.waitForVisibility(driveElement, 5);
//        BrowserUtils.waitForClickablility(driveElement, 5);
//        driveElement.click();
//    }
//
//    public void navigateToCalendar() { //to create a method for a Calendar button
//
//        WebElement calendarElement = Driver.get().findElement(By.cssSelector("[title='Calendar']")); // locator for a calendar
